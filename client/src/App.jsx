    ...
    switch (step) {
      ...
      case 2:
        if (!formData.bloodGroup || !formData.lastDonation) {
          alert("Please provide your blood donation details.");
          return false;
        }
        break;
      case 3:
  ...
  const handleSubmit = async () => {
    try {
      const res = await fetch(
        "https://blood-bank-registration-backend.vercel.app/register",
        {
          method: "POST",
  ...
  return (
    <Router>
      <div className="min-h-screen bg-blue-100 flex items-center justify-center flex-col p-4">
        <h1 className="text-center font-bold text-3xl fixed top-0 underline">
